...
- Analysis and prediction of Air Quality Index
- Mining traffic related information from social media
- Modeling and prediction in LBSNs
- Natural language to structured queries
- Representation and understanding software codes using ML
